...
Коллекцию postman провел, все гуд кроме удаления(из-за этого не мог понять как реализовать ваши комментарии). Прошелся по чек листам, тоже все нормально. Рецепты добавил.